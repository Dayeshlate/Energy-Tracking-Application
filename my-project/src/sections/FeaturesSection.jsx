    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle 
                text1="Features" 
                text2="⚡What you get⚡" 
                text3="Monitor, analyze, and optimize your energy usage in real time." 
            />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    “Voltix helps you cut costs and live greener by turning your energy data into clear insights and smarter savings.” ⚡
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">
                            Voltix empowers you to track consumption, cut waste, and maximize your savings effortlessly.
                        </p>
                        <a href="#" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
                            Learn more about Voltix
